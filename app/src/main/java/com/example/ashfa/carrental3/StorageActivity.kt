package com.example.ashfa.carrental3
...
import com.example.ashfa.carrental3.Model.UploadInfo
import com.example.ashfa.carrental3.viewholder.ImgViewHolder
...
class StorageActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val query = dataReference!!.limitToLast(5)
